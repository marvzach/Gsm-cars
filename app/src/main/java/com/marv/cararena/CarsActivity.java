...
public class CarsActivity extends AppCompatActivity {
    private String[] cars = new String[] {"Audi", "Dodge",
            "Bmw","Nissan GTR", "Buggati",
            "HENNESSEY VENOM", "BUGATTI CHIRON", "KOENIGSEGG CCR",
            "SALEEN S7 TWIN TURBO", "MCLAREN F1"};
    private String[] price = new String[] { "9.1 million dolars", "9.2 million dolars", "8.2 million dolars", "7.2 million dolars", "6.2 million dolars", "5.2 million dolars", "5.8 million dolars", "1.8 million dolars", "4.8 million dolars", "6.8 million dolars", "7.8 million dolars" };
